...
if (!is_dir('../files/posts/data/'))
  mkdir('../files/posts/data/');
...
function load_posts() {
  ...
  if (isset($_GET['state'])) {
    if ($_GET['state'] == 'draft') {
      $state = 'draft';
      $index_file = '../files/posts/index/draft.php';
    }
    else if ($_GET['state'] == 'delete'){
      $state = 'delete';
      $index_file = '../files/posts/index/delete.php';
    }
    else {
      $state = 'publish';
      $index_file = '../files/posts/index/publish.php';
    }
  }
  else {
    $state = 'publish';
...
function delete_post($id) {
  ...
  if ($state != 'delete') {
    $index_file2 = '../files/posts/index/delete.php';
    ...
    unlink('../files/posts/data/'.$id.'.dat');
  }
}
...
function revert_post($id) {
  ...
  $index_file2 = '../files/posts/index/'.$prev_state.'.php';
