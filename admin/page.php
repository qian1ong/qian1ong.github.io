...
if (!is_dir('../files/pages/data/'))
  mkdir('../files/pages/data/');
...
function load_pages() {
  ...
  if (isset($_GET['state'])) {  
    if ($_GET['state'] == 'draft') {
      $state = 'draft';
      $index_file = '../files/pages/index/draft.php';
    }
    else if ($_GET['state'] == 'delete'){
      $state = 'delete';
      $index_file = '../files/pages/index/delete.php';
    }
    else {
      $state = 'publish';
      $index_file = '../files/pages/index/publish.php';
    }
  }
  else {
    $state = 'publish';
...
function delete_page($id) {
  ...
  if ($state != 'delete') {
    $index_file2 = '../files/pages/index/delete.php';
    ...
    unlink('../files/pages/data/'.$page['file'].'.dat');
  }
}
...
function revert_page($id) {
  ...
  $index_file2 = '../files/pages/index/'.$prev_state.'.php';
